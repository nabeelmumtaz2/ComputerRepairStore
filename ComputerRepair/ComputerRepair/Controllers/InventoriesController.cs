...
namespace ComputerRepair.Controllers
{
    public class InventoriesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Comp_Name,Comp_Check_In,Comp_Check_Out,Brand_Name,Is_Ram_Installed,Is_Power_Supply_Installed,Part_Type,Is_Complete_System,Serial_Number,Service_Number,Is_Asset_Tags,Asset_ID,Issues_Note")] Inventory inventory)
        {
            if (ModelState.IsValid)
            {
